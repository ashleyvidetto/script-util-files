ARTIFACT_HOME="/cygdrive/c/LookAhead/Git/IPS_LKA2.0-Release/Streams/Foundation/FlightLegConsumer"
...
artifactNewName="flightlegconsumer-$branchName.sab"
deploymentLocation=/opt/LookAhead/STREAMS/Deployments/$env/ATC/
artifactRemoveCommand="find $deploymentLocation -type f -iname \"*flightleg*.sab\" -delete"
...
printf "\n Copying files......... \n .........";
rsync -Pave ssh --del  --exclude-from='/home/ashle/scripts/exclude-list.txt' --include-from='/home/ashle/scripts/include-list.txt' /cygdrive/c/LookAhead/Git/IPS_LKA2.0-Release/Streams/Foundation/FlightLegConsumer $Server1:~/tmp_builds/
...
cd ~/tmp_builds/FlightLegConsumer/;
sc -M com.aa.lookahead::FlightLegConsumer_Distributed --data-directory=/opt/LookAhead/STREAMS/Config/flightlegconsumer
 cd output/;
